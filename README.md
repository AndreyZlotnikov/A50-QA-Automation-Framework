<h1>Test Pro A50 Class Automation Framework Repository</h1><br>
...
2.) Explore the sample test case in the 'Koel.LoginTests' java class located in the 'src' directory under 'test' > 'java' folder <br>
